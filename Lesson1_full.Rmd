...
why correlation captures only linear dependence ?
...
- concept 1: ts as a sequence of RV

- concept 2: serial dependance

(cycles and seaso)

- concept 3: data transforms 

- concept 4: reg on time (usually bas idea)
