...
# Lesson 7: Active Recall space

\pagebreak

# Lesson 7: Takes and tools 
...
- we have explicit formulas for arma, then what is the step to arIma
...
TP: recoder et refaire JD+ plots, if not pssible why ?
...
Partie 1; concept of spectral distibution (CDF vs PDF), more general than spectral density

computing : from spectral density, here formulas from models 

Partie 2 : DFT and 
periodogram 

here we get to data, moment to 


### R skills

- compute arma (p,q) spectral distrib: from spectral density and then numerical integration (trapeze approx)
- simulate AR(p)
- compute DFT vector
...
## Proposition 7.2.7. Recovering data from DFT vector
